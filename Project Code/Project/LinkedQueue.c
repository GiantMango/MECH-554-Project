...
/* 	
	...
	Name 1:	Taylor Liao			Student ID: V01047298
	Name 2:	Gavin Angman		Student ID: V00846420
...
/**************************************************************************************
* DESC: debug function only to test PINA inputs and shown on the PORTC LEDs
* INPUT: the input get from PINA
*/
